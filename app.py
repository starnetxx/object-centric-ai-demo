#!/usr/bin/env python
"""
Hugging Face Spaces app for CORE Object-Centric AI
"""
...
# Simple scatter_mean implementation
...
class ObjectKernel:
    def __init__(self, latent_dim=128):
        ...
        self.embedding = torch.randn(latent_dim)
        self.properties = {}
...
projections = ProjectionLayer(input_dim=512, latent_dim=latent_dim).to(device)
...
async def predict(req: PredictRequest):
    """Enhanced prediction with real AI capabilities."""
    try:
...
async def root():
    return {
        "message": "CORE - Object-Centric AI API is running on Hugging Face Spaces!",
        "endpoints": {
            "predict": "/predict",
            "health": "/health",
            "docs": "/docs"
...
if __name__ == "__main__":
    ...
    print(f"Starting CORE server on port {port}...")
